...
export default function MyMapPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-start md:justify-center px-3 py-4 md:p-8 bg-gray-100">
      {/* 页面标题 */}
      ...
      */}
      <div className="relative w-full max-w-3xl aspect-square overflow-hidden rounded-md md:rounded-lg shadow-lg md:shadow-2xl">
